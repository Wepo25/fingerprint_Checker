...
public class Main {
  ...
  public static void testtransition() {
    ...
    boolean[] neighbours = {false, false, true,false,
      false, false, true, false};
    int value = Fingerprint.transitions(neighbours);
    System.out.println(value);
  }
  public static void testidentical() {
    System.out.print("testidentical: ");
    boolean[][] image1 = {{true,  false, false, true,  true},
                         {true,  false, true,  true,  false},
                         {true,  true,  false, false, false},
                         {false, true,  false, true,  false}};
    boolean[][] image2 = {{true,  false, false, true,  true},
                         {true,  false, true,  true,  false},
                         {true,  true,  false, false, false},
                         {false, true,  false, true,  false}};
    Fingerprint.thin(image1);
    boolean answer = Fingerprint.identical(image1, image2);
  ...
  public static void testApplyRotation() {
    ...
    System.out.print("testApplyRotation 1: ");
    int[] minutia = new int[] {1, 3, 10};
    int[] result1 = Fingerprint.applyRotation(minutia, 0, 0, 0);
    int[] expected1 = {1,3,10};
    ...
    System.out.print("testApplyRotation 2: ");
    ...
    int[] expected3 = {-3,1,100};
    System.out.print("testApplyRotation 3: ");
    ...
    int[] expected4 = {-3,0,100};
    System.out.print("testApplyRotation 4: ");
    ...
    int[] expected5 = {0,3,100};
    System.out.print("testApplyRotation 5: ");
  ...
  public static void testApplyTranslation() {
    ...
    System.out.print("testApplyTranslation 1: ");
